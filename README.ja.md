...
- **M5Stack Tab5/StickS3:** ビルド済みのファームウェアを [M5Burner](https://docs.m5stack.com/en/download)
  から書き込めます。M5Burner の Tab5/StickS3 のリストで "Devour Sphere" を探してください。
- **その他のボード:** Xiamocon (RP2350 / ESP32S3)、PicoSystem、ESPboy のバイナリは
